...
public class CategoryListTask extends
		AsyncTask<String, Integer, CategoryResponse> {

	public interface OnCategoryResponseListener {
		public void onSuccess(CategoryResponse response);
		public void onError();
	}
	
	OnCategoryResponseListener mListener;
	
	public CategoryListTask(OnCategoryResponseListener listener) {
		super();
		mListener = listener;
	}
	...
	protected CategoryResponse doInBackground(String... params) {
		...
		requestBundle.setUrl("http://apis.skplanetx.com/11st/common/categories");
